...
{\Huge\bfseries ISI MSQE PEA 2023 PYQ Practice Booklet\par}
\vspace{0.4cm}
...
\item $f$ continuous but not differentiable
\item $f$ decreasing
\end{enumerate}
\vspace{0.35cm}
\hrule
...
\begin{enumerate}[label=(\Alph*)]
\item $\mathbb R^2\setminus D$ is convex
\item $\mathbb R^2_+\setminus D$ is convex
\item $D$ is not convex
