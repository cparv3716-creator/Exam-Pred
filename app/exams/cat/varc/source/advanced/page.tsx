...
export const metadata: Metadata = { title: "CAT VARC Source – Advanced" };

export default function CatVarcSourceAdvancedPage() {
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-8">
          <SectionHeader
            ...
            title="Advanced VARC practice from source."
            description="High-difficulty RC sets and challenging verbal reasoning questions preserved directly from source PDFs."
          />
        </div>
        <div className="mt-10">
