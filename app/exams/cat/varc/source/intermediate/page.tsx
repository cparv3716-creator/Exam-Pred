...
export const metadata: Metadata = { title: "CAT VARC Source – Intermediate" };
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-8">
          <SectionHeader
            ...
            title="Intermediate VARC practice from source."
            description="CAT-level RC passages and verbal reasoning questions preserved directly from source PDFs."
          />
        </div>
        <div className="mt-10">
