...
### Q4. QA - Arithmetic / Ratio and Proportion
...
### Q20. QA - Arithmetic / Ratio and Proportion
...
### Q21. QA - Algebra / Functions

- Archetype/type: Function value/domain problem
- Difficulty: Hard
- Score: 0.852

For real $x$, define \[ f(x)= \begin{cases} \dfrac{x-2}{x+1}, & x<1,\ x\ne -1,\\[4pt] \sqrt{x-1}, & x\ge 1. \end{cases} \] For how many integers $x$ in the interval $[-10,20]$ is $f(f(x))$ defined and greater than $1$?
...
### Q22. QA - Arithmetic / Ratio and Proportion

- Archetype/type: Ratio sharing problem
- Difficulty: Hard
- Score: 0.843

Two boxes A and B contain tokens in the ratio 13:8. Some tokens are moved from A to B, after which the ratio becomes 5:4. If 42 more tokens are then moved from A to B and the two boxes become equal, what was the total number of tokens initially?
...
Let the daily rates of A, B and C be a, b and c. We have a+b = 1/16, b+c = 1/24, and a+c = 1/18. Adding gives 2(a+b+c) = 1/16 + 1/24 + 1/18 = 9/144 + 6/144 + 8/144 = 23/144, so a+b+c = 23/288. Also a = [(a+b)+(a+c)-(b+c)]/2 = (1/16 + 1/18 - 1/24)/2 = (9+8-6)/144 divided by 2 = 11/288. Similarly c = [(b+c)+(a+c)-(a+b)]/2 = (6+8-9)/144 divided by 2 = 5/288. In the first 4 days A completes 4 x 11/288 = 44/288 = 11/72. In the next 3 days A+C complete 3 x (16/288) = 48/288 = 1/6. Work done in first 7 days = 11/72 + 1/6 = 23/72. Remaining work = 49/72. With all three working, time needed = (49/72)/(23/288) = 196/23 days. Total time = 7 + 196/23 = 357/23 days.
...
Step 1: Let the original shares be 5x, 7x and 8x. After B gives Rs 22000 to A, A has 5x + 22000 and B has 7x - 22000. C still has 8x. Step 2: C's excess over A at this point is 8x - (5x + 22000) = 3x - 22000. One-fourth of this amount is transferred from C to B, so B receives (3x - 22000)/4. Step 3: Final A = 5x + 22000. Final B = 7x - 22000 + (3x - 22000)/4. Step 4: They are equal, so 5x + 22000 = 7x - 22000 + (3x - 22000)/4. Multiplying by 4 gives 20x + 88000 = 28x - 88000 + 3x - 22000 = 31x - 110000. Step 5: Hence 11x = 198000, so x = 18000. C's original share = 8x = Rs 144000.

### Q21

Step 1: The composition $f(f(x))$ is defined only if $x$ is in the domain of $f$ and the intermediate value $f(x)$ is also in the domain of $f$. Thus $x=-1$ is automatically excluded. Step 2: First consider $x<1$. Then \[ f(x)=\frac{x-2}{x+1}. \] For $f(f(x))>1$ with the intermediate input below $1$, we need \[ \frac{y-2}{y+1}>1,\quad \text{where } y=f(x). \] This gives \[ \frac{-3}{y+1}>0 \Rightarrow y<-1. \] Step 3: Now solve \[ \frac{x-2}{x+1}<-1. \] For $x<-1$, multiplying by the negative denominator reverses the sign: \[ x-2>-x-1 \Rightarrow 2x>1, \] which gives no integer $x<-1$. For $-1<x<1$, the only integer is $x=0$, and it gives \[ f(0)=-2,\quad f(-2)=4>1. \] So $x=0$ works. Step 4: Now consider $x\ge 1$. Then \[ f(x)=\sqrt{x-1}. \] If $0\le f(x)<1$, then the first branch is used next and cannot exceed $1$ because \[ \frac{y-2}{y+1}>1 \] would require $y<-1$, which is impossible for $y\ge0$. Step 5: Therefore we need $f(x)\ge 1$ and \[ f(f(x))=\sqrt{\sqrt{x-1}-1}>1. \] This gives \[ \sqrt{x-1}-1>1 \Rightarrow \sqrt{x-1}>2 \Rightarrow x>5. \] Step 6: The integers from $6$ to $20$ give $15$ values. Including $x=0$, the total number of valid integers is \[ 15+1=16. \]

### Q22

Step 1: Let the initial numbers be 13k and 8k. Suppose x tokens are first moved from A to B. Step 2: Then (13k - x)/(8k + x) = 5/4. Cross-multiplying gives 52k - 4x = 40k + 5x, so 12k = 9x and x = 4k/3. Step 3: After this transfer, the boxes have 13k - 4k/3 = 35k/3 and 8k + 4k/3 = 28k/3 tokens. Step 4: Moving 42 more from A to B makes them equal, so 35k/3 - 42 = 28k/3 + 42. Step 5: Therefore 7k/3 = 84, so k = 36. Initial total = 21k = 756.

## Evidence Lineage

| Q | Candidate | Source Question IDs |
| ---: | --- | --- |
| 1 | CAT_QA_SPEC_01_ELITE_03 | CAT_2017_S1_QA_Q12;CAT_2017_S2_QA_Q07;CAT_2017_S2_QA_Q09 |
| 2 | CAT_QA_SPEC_10_CORRECTED_04 | CAT_2018_S1_QA_Q01;CAT_2018_S1_QA_Q14 |
| 3 | CAT_QA_SPEC_06_ELITE2_03 | CAT_2017_S1_QA_Q01;CAT_2017_S1_QA_Q05;CAT_2017_S1_QA_Q06 |
| 4 | CAT_QA_SPEC_03_ELITE_01 | CAT_2017_S1_QA_Q13;CAT_2018_S1_QA_Q26;CAT_2019_S1_QA_Q12 |
| 5 | CAT_QA_SPEC_07_CLAUDE_01 | CAT_2017_S1_QA_Q16;CAT_2018_S1_QA_Q09;CAT_2018_S1_QA_Q29 |
| 6 | CAT_QA_SPEC_02_CAND_03 | CAT_2017_S1_QA_Q34;CAT_2017_S2_QA_Q34;CAT_2018_S1_QA_Q28 |
| 7 | CAT_QA_SPEC_15_GPT55Thinking_AVGDIV_01 | CAT_2017_S1_QA_Q21;CAT_2017_S2_QA_Q26;CAT_2018_S2_QA_Q02;CAT_2019_S2_QA_Q02;CAT_2020_S1_QA_Q08;CAT_2020_S1_QA_Q10;CAT_2020_S3_QA_Q06;CAT_2020_S3_QA_Q17 |
| 8 | CAT_QA_SPEC_08_CLAUDE_07 | CAT_2017_S1_QA_Q03;CAT_2017_S1_QA_Q26;CAT_2017_S2_QA_Q29 |
| 9 | CAT_QA_SPEC_12_GENSPARK_FINAL_01 | CAT_2017_S1_QA_Q28;CAT_2018_S2_QA_Q29;CAT_2019_S2_QA_Q31 |
| 10 | CAT_QA_SPEC_13_CLAUDE_04 | CAT_2018_S2_QA_Q30;CAT_2019_S1_QA_Q09;CAT_2019_S2_QA_Q10 |
| 11 | CAT_QA_SPEC_16_GENSPARK_FINAL_01 | CAT_2017_S1_QA_Q23;CAT_2018_S1_QA_Q11;CAT_2019_S2_QA_Q19 |
| 12 | CAT_QA_SPEC_18_GPT55Thinking_COORDMENS_04 | CAT_2017_S1_QA_Q24;CAT_2019_S1_QA_Q03;CAT_2019_S1_QA_Q28;CAT_2020_S1_QA_Q05;CAT_2020_S1_QA_Q09;CAT_2020_S1_QA_Q21;CAT_2020_S1_QA_Q25;CAT_2020_S2_QA_Q04 |
| 13 | CAT_QA_SPEC_04_ELITE_01 | CAT_2017_S1_QA_Q04;CAT_2017_S2_QA_Q04;CAT_2018_S1_QA_Q04 |
| 14 | CAT_QA_SPEC_11_CORRECTED_01 | CAT_2017_S2_QA_Q15;CAT_2017_S2_QA_Q21;CAT_2017_S2_QA_Q27 |
| 15 | CAT_QA_SPEC_19_GPT55Thinking_COORDMENS_05 | CAT_2017_S1_QA_Q18;CAT_2017_S1_QA_Q19;CAT_2018_S1_QA_Q13;CAT_2019_S2_QA_Q24;CAT_2020_S1_QA_Q16;CAT_2020_S1_QA_Q17;CAT_2024_S1_QA_Q16 |
| 16 | CAT_QA_SPEC_20_GPT55Thinking_AVGDIV_08 | CAT_2019_S2_QA_Q06;CAT_2022_S2_QA_Q13;CAT_2023_S1_QA_Q04;CAT_2023_S2_QA_Q06;CAT_2023_S3_QA_Q06;CAT_2025_S1_QA_Q19 |
| 17 | CAT_QA_SPEC_06_ELITE2_01 | CAT_2017_S1_QA_Q01;CAT_2017_S1_QA_Q05;CAT_2017_S1_QA_Q06 |
| 18 | CAT_QA_SPEC_06_CLAUDE_06 | CAT_2017_S2_QA_Q06;CAT_2017_S2_QA_Q10 |
| 19 | CAT_QA_SPEC_06_ELITE2_02 | CAT_2017_S1_QA_Q01;CAT_2017_S1_QA_Q05;CAT_2017_S1_QA_Q06 |
| 20 | CAT_QA_SPEC_03_ELITE_03 | CAT_2018_S1_QA_Q26;CAT_2018_S2_QA_Q34;CAT_2019_S1_QA_Q23 |
| 21 | CAT_QA_SPEC_13_GPT55Thinking_FUNCIRC_01 | CAT_2017_S2_QA_Q31;CAT_2017_S2_QA_Q32;CAT_2018_S1_QA_Q03;CAT_2018_S1_QA_Q33;CAT_2018_S2_QA_Q30;CAT_2019_S1_QA_Q09;CAT_2019_S1_QA_Q33;CAT_2019_S2_QA_Q10 |
| 22 | CAT_QA_SPEC_03_ELITE_02 | CAT_2017_S2_QA_Q14;CAT_2018_S1_QA_Q34;CAT_2018_S2_QA_Q33 |